  ...
  return (
    <div className="space-y-8 p-8">
      <section className="rounded-[32px] bg-slate-950 px-8 py-10 text-white shadow-xl">
        <p className="text-xs font-semibold uppercase tracking-[0.32em] text-emerald-300">Separate Backend Section</p>
      ...
      <section className="grid gap-6 xl:grid-cols-2">
        <Link href="/admin/content" className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm hover:border-emerald-200">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-emerald-600">Frontend Content</p>
          <h2 className="mt-4 text-2xl font-semibold text-slate-900">Edit visible frontend information</h2>
          <p className="mt-3 text-sm text-slate-500">
            Update login page text, sidebar branding, dashboard titles, and quick action labels from the backend.
          </p>
        </Link>

        <Link href="/admin/data" className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm hover:border-blue-200">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-blue-600">Data Control</p>
          <h2 className="mt-4 text-2xl font-semibold text-slate-900">Open data management tools</h2>
          <p className="mt-3 text-sm text-slate-500">
