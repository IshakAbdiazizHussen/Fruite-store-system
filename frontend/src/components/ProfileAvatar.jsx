...
export default function ProfileAvatar({
  ...
  return (
    <div
      className={`flex items-center justify-center overflow-hidden rounded-full border border-slate-200 bg-white p-2 shadow-[0_10px_24px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-slate-950 ${sizeClassName} ${frameClassName}`}
    >
      <img
        src={resolvedSrc}
        alt={alt}
